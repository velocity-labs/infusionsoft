module Infusionsoft
  ...
  class Email < Base
    ...
    def self.email_add(title, categories, from, to, cc, bcc, subject, text_body, html_body,
    ...
    def self.email_attach(contact_id, from_name, from_address, to_address, cc_addresses,
    ...
    def self.email_get_available_merge_fields(merge_context)
    ...
    def self.email_get_template(id)
    ...
    def self.email_get_opt_status(email_address)
    ...
    # @return [Boolean]
    def self.email_optin(email_address, reason)
    ...
    # @param [String] reason
    # @return [Boolean]
    def self.email_optout(email_address, reason)
    ...
    def self.email_send(contact_list, from_address, to_address, cc_addresses,
    ...
    def self.email_send_template(contact_list, template_id)
    ...
    def self.email_update_template(id, title, category, from, to, cc, bcc, subject,
